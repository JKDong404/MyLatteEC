...
import com.mymxhbyf.dongjk.lattecore.net.rx.RxRestService;
...
public class RestCreator {
    ...
    private static final class RetrofitHolder {
        ...
        private static final Retrofit RETROFIT_CLIENT = new Retrofit.Builder()
                ...
                .addCallAdapterFactory(RxJava2CallAdapterFactory.create())//rxjava时使用
                .build();
    }
    ...
    private static final class OKHttpHolder {
        ...
        private static final OkHttpClient OK_HTTP_CLIENT = addInterceptor() //new OkHttpClient.Builder()
